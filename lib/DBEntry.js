            ...
            switch (retrieval_type) {
                ...
                case "include":
                    ...
                    for(const key in current_ref) {
                        ...
                        //console.log("--key_in_object_bool:",key_in_object_bool);
                        //console.log("--container_force:",(container_force) ? true : false);
                        //console.log("--container_continue:",(container_continue) ? true : false);
                        ...
                        if(key_in_object_bool || container_force || container_continue) {
                            if(current_ref[key].var_type === "container") {
                                ...
                                //(container_force) ? console.log("--container_force is set\n") : console.log("");;
    ...
    const checkForEmptyCycle = (is_required_set,require_object_ref,current_ref,container_force) => {
        ...
        if(is_required_set) {
            ...
            for(const key in current_ref) {
                ...
                //console.log("--key_in_object_bool:",key_in_object_bool,"\n");
                //console.log("--container_force:",container_force,"\n");
                if(key_in_object_bool || container_force || container_continue) {
