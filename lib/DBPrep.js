...
const DBPrep = function() {
    ...
    var getEntry_templates = [];

    var checkForEmpty_templates = [];
    ...
    */
    ...
    @params: template_reg [object], holds regex to use for the template values
    */
    this.createTmplt = (template_name,template_obj,template_reg) => {
        if(template_name && template_obj) {
            templates.push(new DBTmplt(template_name,template_obj,template_reg));
        } else {
